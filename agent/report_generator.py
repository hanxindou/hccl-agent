...
class ReportGenerator:
    ...
    def generate_official_validation_report(
        ...
        lines = [
            ...
            f"Reduce Operation: {result.get('reduce_op') or 'N/A'}",
            f"Element Count: {result.get('elements', 'N/A')}",
            f"Byte Count: {result.get('byte_count', 'N/A')}",
            f"Input Bytes Per Rank: {result.get('input_bytes_per_rank', 'N/A')}",
            f"Output Bytes Per Rank: {result.get('output_bytes_per_rank', 'N/A')}",
            ...
            f"Warning Regression: {result.get('warning_regression', False)}",
