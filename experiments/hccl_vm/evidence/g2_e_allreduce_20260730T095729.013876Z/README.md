...
Outer Exit Code: 0
HCCL-VM Normal Shutdown: True
Evidence Directory: experiments/hccl_vm/evidence/g2_e_allreduce_20260730T095729.013876Z
Checker Operation Summaries:
  opIndex=0, collectiveType=AllReduce, rankCount=2, dataType=INT32, elementCount=16, reduceType=SUM
  opIndex=1, collectiveType=AllReduce, rankCount=2, dataType=INT32, elementCount=16, reduceType=SUM
```
