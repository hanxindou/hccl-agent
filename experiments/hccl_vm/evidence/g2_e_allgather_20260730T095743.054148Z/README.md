...
Rank Count: 2
Data Type: int32
Reduce Operation: N/A
Element Count: 8
Byte Count: 64
Input Bytes Per Rank: 32
Output Bytes Per Rank: 64
Checker Success: True
Metadata Match: True
ErrorCode 103 Warnings: 4
...
Outer Exit Code: 0
HCCL-VM Normal Shutdown: True
Evidence Directory: experiments/hccl_vm/evidence/g2_e_allgather_20260730T095743.054148Z
Checker Operation Summaries:
  opIndex=0, collectiveType=AllGather, rankCount=2, dataType=INT32, elementCount=8, reduceType=SUM
  opIndex=1, collectiveType=AllGather, rankCount=2, dataType=INT32, elementCount=8, reduceType=SUM
```
